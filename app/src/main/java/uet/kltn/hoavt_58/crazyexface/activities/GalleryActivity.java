...
import uet.kltn.hoavt_58.crazyexface.adapters.DrawerAdapter;
import uet.kltn.hoavt_58.crazyexface.fragments.GalleryContainerFrag;
import uet.kltn.hoavt_58.crazyexface.fragments.GalleryFooterFrag;
...
import uet.kltn.hoavt_58.crazyexface.ui.VerticalSpaceItemDecoration;

/**
 * Created by Adm on 8/10/2016.
 */
public class GalleryActivity extends AppCompatActivity implements OnGalleryListener, DrawerAdapter.OnNavigationItemSelectedListener {
    ...
    public static final String EXTRA_OUTPUT_PATH_KEY = "EXTRA_OUTPUT_PATH_KEY";
...
//        Log.d(TAG, "perform Animation");
        ...
        translate.setDuration(ConstValue.GALLERY_SHARED_ITEM_INTERVAL);
        ...
        scaleAnimation.setDuration(ConstValue.GALLERY_SHARED_ITEM_INTERVAL);
...
//                        galleryFooterFrag.getImgAdapter().notifyDataSetChanged();
    ...
    private void initNavigationView() {
        ...
        navView.addItemDecoration(new VerticalSpaceItemDecoration(Utils.dpToPx(this, 1)));
