 ...
 */
public class GridContainerFrag extends BaseFragment {
    ...
    private void initViewPager() {
        ...
        viewPager.setAdapter(new GridAdapter(getChildFragmentManager(), getActivity(), Statistic.GRID_LAYOUT_CODE));
