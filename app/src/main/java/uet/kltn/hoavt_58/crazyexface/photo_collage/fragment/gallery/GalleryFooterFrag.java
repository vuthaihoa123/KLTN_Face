...
import uet.kltn.hoavt_58.crazyexface.photo_collage.adapter.gallery.GalleryFooterAdapter;
 ...
 */
public class GalleryFooterFrag extends BaseFragment implements View.OnClickListener {
    ...
    private void initViews() {
        ...
        if (getActivity().getIntent() != null)
            curIndex = getActivity().getIntent().getIntExtra(Statistic.EXTRA_CURRENT_SELECTED_RECT, 0);
...
//                data.putExtra(GalleryActivity.OUTPUT_PATH_KEY, imgAdapter.getOutput());
