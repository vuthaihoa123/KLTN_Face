...
//        Flog.d("GalleryFooterAdapter");
        ...
        itemCount = activity.getIntent().getIntExtra(GalleryActivity.EXTRA_NUM_PICKED_FRAME_KEY, 3);
        curIndex = activity.getIntent().getIntExtra(Statistic.EXTRA_CURRENT_SELECTED_RECT, 0);
