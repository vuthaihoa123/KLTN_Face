 ...
 */
public class PhotoEditorFrag extends BaseFragment {
    private static final String TAG = PhotoEditorFrag.class.getSimpleName();

    private RecyclerView recyclerView = null;
    private PhotoEditorAdapter adapter = null;
    private int mCurIndex = -1;

    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.photo_editor_layout, container, false);
    }
    ...
    private void initRecycleView() {
        adapter = new PhotoEditorAdapter(getActivity()).setOnPhotoEditorListener((MainEditorActivity) getActivity());
    ...
    public PhotoEditorFrag setCurIndex(int curIndex) {
        mCurIndex = curIndex;
        return this;
    }
